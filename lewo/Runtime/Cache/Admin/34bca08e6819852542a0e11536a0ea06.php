<?php if (!defined('THINK_PATH')) exit();?><!--Footer-part-->
...
<script type="text/javascript">
 ...
 var ajax_check_bill_rul = "<?php echo U('Admin/Houses/ajax_check_bill');?>";
 var refesh_schedule_count_url = "<?php echo U('Admin/Index/refesh_schedule_count');?>";
