...
<div>
  <div class="widget-box">
    <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
      ...
      <span class="label label-warning">该租客所有未支付的账单。</span>
    </div>
      ...
      <tbody>
        ...
        <tr>
          <td colspan="24">
            ...
            <h3>抵扣后押金：￥<?php echo ($residue_deposit); ?></h3>
            <span class="label label-important">因押金抵扣￥<?php echo ($sum_total_fee); ?>，抵扣后押金余额剩下<?php echo ($residue_deposit); ?>。</span>
          </td>          
        </tr>
        <tr>
          <td colspan="24">
          <a href="<?php echo U('Admin/Task/send_back_bill',array('schedule_id'=>$schedule_id,'residue_deposit'=>$residue_deposit));?>" class="btn btn-success">发送确认</a>
          </td>
        </tr>
      </tbody>
    </table>
