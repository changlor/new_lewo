...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <body>
<div id="denglu">
	<div><a href="<?php echo U('Home/Tenant/login');?>" class="but_color">我是租客</a></div>
    ...
    <div class="inner_icon">
    	<form action="<?php echo U('Home/Steward/login');?>" method="post" id="login">
			...
			<div class="icon_pic">
           	...
           	<div class="button">
            	<a href="javascript:submit();"><p class="but_color">管家登录</p></a>
            </div>
    	</form>
	</div>
</div>
