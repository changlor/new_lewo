...
<div>
  <div class="widget-box">
   <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
    ...
    <form action="<?php echo U('Admin/Houses/add_area');?>" method="post" enctype="multipart/form-data" class="form-horizontal form-inline" onsubmit="return checkAddArea();">
      <!-- 房屋信息 -->
      <table class="table table-condensed">
        <tbody>
          ...
          <tr>
            ...
            <td><input name="area_name" type="text" class="span2" value=""></td>
          </tr>
          <tr>
            <td width="130"><i class="icon-home"></i>小区简介：</td>
            <td><input name="area_description" type="text" class="span2" value=""></td>
          </tr>
          <tr>
            ...
            <td>
              <select name="city_id">
                ...
                <?php if(is_array($city_id)): $i = 0; $__LIST__ = $city_id;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($key); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
              </select>
            </td>
          </tr>
          <tr>
            <td width="130"><i class="icon-home"></i>阶梯电费:</td>
            <td><input name="energy_stair" type="text" class="span2" value=""><span class="label label-important">格式：开始度数-结束度数-电费(0-200-1.5,200-400-3)</span></td>
          </tr>
          <tr>
            <td width="130"><i class="icon-home"></i>水费单价:</td>
            <td><input name="water_unit" type="text" class="span2" value=""></td>
          </tr>
          <tr>
            <td width="130"><i class="icon-home"></i>气费单价:</td>
            <td><input name="gas_unit" type="text" class="span2" value=""></td>
          </tr>
          <tr>
            <td width="130"><i class="icon-home"></i>燃气垃圾费:</td>
            <td><input name="rubbish_fee" type="text" class="span2" value=""></td>
          </tr>
