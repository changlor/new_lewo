...
<div id="fwxx">
    ...
    <form action="<?php echo U('Home/Steward/order');?>" method="post" enctype="multipart/form-data" onsubmit="return checkform(this)">
      <div id="wrapper">
        <div>
          <div class="main main_margin_top44">
            <div class="main_hezi">
              <h2>
                <span class="title">交定信息</span>
              </h2>
              <h2>
                <p class="title_jd"><?php echo ($room_info['room_code']); ?><input type="hidden" name="id" value="<?php echo ($room_info['id']); ?>"></p>
              </h2>
            </div>
            <input type="hidden" value="<?php echo ($room_info['house_code']); ?>" name="house_code">
            <div class="main_ban">
              <ul class="ban_tietu">
                <li class="ban_one zbj20 "><span class="text-letter-spacing-2ys">姓名：</span></li>
                <li class="ban_two">
                  <input type="text" value="" name="realname" id="realName" class="shuru">
                </li>
                <li class="xiantiao"></li>
              </ul>
            </div>
            <input type="hidden" name="accountId" value="" class="">
            <div class="main_ban">
              <ul class="ban_tietu">
                <li class="ban_one zbj20 "><span class="text-letter-spacing-2ys">电话：</span></li>
                <li class="ban_two">
                  <input type="text" value="" name="mobile" id="mobile" class="shuru">
                </li>
                <li class="xiantiao"></li>
              </ul>
            </div>
            <div class="main_ban">
              <ul class="ban_tietu">
                <li class="ban_one zbj20 "><span class="text-letter-spacing-3ys">交定定金：</span></li>
                <li class="ban_two">
                  <input type="text" value="" name="money" id="fee" class="shuru">
                </li>
                <li class="xiantiao"></li>
              </ul>
            </div>
            <div class="main_ban">
              <ul class="ban_tietu">
                <li class="ban_one zbj20 ">约定签约时间：</li>
                <li class="ban_two">
                  <input type="text" value="" id="endDate" name="appoint_time" class="shuru" readonly="">
                </li>
                <li class="xiantiao"></li>
              </ul>
            </div>
            <div class="main_ban">
              <ul class="ban_tietu">
                <li class="ban_one zbj20 "><span class="text-letter-spacing-3ys">备注：</span></li>
                <li class="ban_two">
                  <input type="text" value="" name="msg" id="fee" class="shuru">
                </li>
                <li class="xiantiao"></li>
              </ul>
            </div>
