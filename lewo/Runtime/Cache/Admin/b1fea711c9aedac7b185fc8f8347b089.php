  ...
  <ul class="nav">
    <li class="dropdown" id="profile-messages" >
      <a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle">
        ...
        <span class="text">欢迎<?php echo ($_SESSION['admin_type_name']); echo ($_SESSION['username']); ?></span>
      <b class="caret"></b>
      </a>
   ...
   <!--  <li class="dropdown" id="menu-messages">
    ...
    <li class=""><a title="" href="<?php echo U('Admin/Index/login_out');?>"><i class="icon icon-share-alt"></i> <span class="text">退出</span></a></li>
  </ul>
</div>
